    ...
    return (
        <>
            <div className="container-fluid mt-3">
                ...
                <div className="row">
                    <div className="col-md-7">
                        <div className="col-12 rounded pt-5 mt-5 d-none d-md-block" style={{ padding: "10px", backgroundColor: "var(--navbarColor)", height: '65vh' }}>
                            <div className="d-flex ms-md-5 gap-4 mt-5 mt-md-5 justify-content-start align-items-center gap-4">
                                <div className="text-center text-md-start">
                                    <h1 className="fs-1" style={{ color: "var(--textColor)" }}>ELEVATING BRANDS</h1>
                                    <h1 className="fs-1" style={{ color: "var(--textColor)" }}>IN THE DIGITAL AGE</h1>
                                </div>
                                <img className="img-fluid mb-5" src={Button} alt="Button Image" />
                            </div>
                        </div>

                        {/******** visible on small screen  *********/}

                        <div className="col-12 rounded pt-4 h-100 d-md-none" style={{ backgroundColor: "var(--navbarColor)" }}>
                            <div className="d-flex flex-column flex-md-row justify-content-start align-items-start ms-4">
                                <div className="text-center text-md-start ">
                                    <h1 className="fs-1" style={{ color: "var(--textColor)" }}>ELEVATING BRANDS</h1>
                                    <h1 className="fs-1" style={{ color: "var(--textColor)" }}>IN THE DIGITAL AGE</h1>
                                </div>
                                <img className="img-fluid mb-5 mb-md-5" src={Button} alt="Button Image" />
                            </div>
                        </div>
                    </div>

                    <div className="col-md-5">
                        <div className="col-md-12 rounded pt-5 pt-md-2 mt-3 mt-md-5" style={{ backgroundColor: "var(--navbarColor)", height: '65vh' }}>
                            <div className="row">
                                <div className="row">
                                    {cards.map((item, index) => (
                                        <div key={index} className="col-6 mb-0 mt-2">
                                            <div
                                                ...
                                                <div>
                                                    <p className="pt-2 mb-0" style={{ color: "var(--textColor)" }}>{item.content}</p>
                                                    <h5 className="fs-1 mt-0" style={{ color: "var(--aboutNumberColor)" }}>{item.number}</h5>
                                                </div>
                                            </div>
                                        </div>
                                    ))}
                                    <div className="d-flex justify-content-center align-items-center gap-2 mt-4">
                                        ...
                                        <p className="fs-5" style={{ color: "var(--textColor)" }}>KNOW MORE</p>
                                    </div>
                ...
                {/*********************SECOND COMPONENT*******************/}
                {/**************MEET OUR TEAM***************/}
                <div className="p-1 p-md-3 mt-5 rounded" style={{ border: "2px solid var(--navbarColor)" }}>
                    <div className="d-flex justify-content-between align-items-center p-4 mt-1 rounded" style={{ backgroundColor: "var(--navbarColor)" }}>
                        <h3 style={{ color: "var(--textColor)" }}>MEET THE BRILLIANT MINDS BEHIND NEXGEN</h3>
                    ...
                    <div className="container-fluid mt-3">
                        <div className="row">
                            {members.slice(0, showMore || !isMobile ? acheivements.length : 3).map((member, index) => (
                                <div key={index} className="col-md-3">
                                    <div className="p-4 mt-2 rounded" style={{ background: "linear-gradient(to bottom, var(--btnBackground) 50%, var(--navbarColor) 50%)", textAlign: "center" }}>
                                        <h5 className="mt-2" style={{ color: "var(--servicesText)" }}>{member.name}</h5>
                                        <p style={{ color: "var(--paragraphText)" }}>{member.post}</p>
                                        ...
                                        <div className="d-flex justify-content-center mt-3">
                                            <span className="w-25"><img src={member.fb} alt="Facebook" /></span>
                                            <span className="w-25"><img src={member.twitter} alt="Twitter" /></span>
                                            <span className="w-25"><img src={member.linkedIn} alt="LinkedIn" /></span>
                                        </div>
                                    </div>
                                </div>
                            ))}
                        ...
                        <div className="">
                                <button className="d-md-block mt-4 d-md-none w-100 d-flex gap-2  p-2 justify-content-center align-items-center rounded backgroundColor"  onClick={() => setShowMore(!showMore)}  style={{ color: "var(--paragraphText)", outline: "none", border: 'none', transition: "ease-in-out 0.3s" }}>
                ...
                {/********************THIRD COMPONENT*********************/}
                {/************* OUR ACHIEVMENTS *************/}
                <div className="p-2 p-md-4 mt-3 mt-md-5 rounded" style={{ border: "2px solid var(--navbarColor)" }}>
                    <div className="p-4 p-md-4 rounded d-flex justify-content-center align-items-center justify-content-md-start align-items-md-start" style={{ backgroundColor: "var(--navbarColor)" }}>
                        <h3 className="" style={{ color: "var(--textColor)" }}>OUR ACHIEVMENTS</h3>
                    </div>
                    <div className="row">
                        {acheivements.slice(0, showMore || !isMobile ? acheivements.length : 3).map((acheivement, index) => (
                            <div key={index} className="col-md-3 mt-2">
                                <div className="mt-3 rounded w-100 h-100" style={{ backgroundColor: "var(--navbarColor)" }} >
                                    <p className="p-4 mb-2" style={{ color: "var(--navbarLinksColor)" }}>{acheivement.month}</p>
                                    <div className="d-flex p-4 justify-content-center align-items-center mb-2" style={{ height: "20vh", backgroundColor: "var(--btnBackground" }}>
                                        <h5 style={{ color: "var(--textColor)" }}>{acheivement.header}</h5>
                                    </div>
                                    <p className="p-4" style={{ color: "var(--paragraphText)" }}>{acheivement.para}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                    <div className="d-block mt-4 d-md-none d-flex gap-2 w-100 p-2 justify-content-center align-items-center rounded backgroundColor">
                                <button className="d-block d-md-none d-flex gap-2 w-100 p-2 justify-content-center align-items-center rounded backgroundColor" onClick={() => setShowMore(!showMore)} style={{ color: "var(--paragraphText)", outline: "none", border: 'none', transition: "ease-in-out 0.3s" }}>
                                <img src={showMore ? rightArrow : downbtn} alt="" />
                ...
                <div className="p-3 mt-5 rounded" style={{ border: "2px solid var(--navbarColor)" }}>
                    <div className="p-4 mb-3 rounded" style={{ backgroundColor: "var(--navbarColor)" }}>
                        <h3 style={{ color: "var(--textColor)" }}>AWARDS AND RECOGNITIONS</h3>
                    </div>
                    <div className="row">
                        {awards.slice(0, showMore || !isMobile ? awards.length : 3).map((award, index) => (
                            <div key={index} className="col-md-3">
                                <div className="rounded" style={{ backgroundColor: "var(--navbarColor)" }} >
                                    <div className="d-flex justify-content-between align-items-center p-3">
                                        <p className="p-2 rounded-pill" style={{ backgroundColor: "var(--btnBackground)", color: "var(--navbarLinksColor)" }}>{award.dates}</p>
                                        <img className="w-25" style={{ width: "4vw" }} src={award.icon} alt="" />
                                    </div>
                                    <div className="d-flex p-2 justify-content-center align-items-center">
                                        <h5 style={{ color: "var(--textColor)" }}>{award.header}</h5>
                                    </div>
                                    <p className="p-4" style={{ color: "var(--paragraphText)" }}>{award.para}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div>
                        <button className="d-block pt-2 pb-2 d-md-none w-100 d-flex gap-2 justify-content-center align-items-center rounded backgroundColor" onClick={() => setShowMore(!showMore)} style={{ color: "var(--paragraphText)", outline: "none", border: 'none', transition: "ease-in-out 0.3s" }}>
                                <img src={showMore ? rightArrow : downbtn} alt="" />
            ...
            <div className="p-3 mt-3 mt-md-5 rounded" style={{ border: "2px solid var(--navbarColor)" }}>
                ...
                <div className="d-flex justify-content-between align-items-center  p-4 mt-5 rounded" style={{ backgroundColor: "var(--navbarColor)" }}>
                                ...
                                <div className="col-md-12">
                                    <div className="card d-flex" style={{ backgroundColor: 'var(--navbarColor)' }}>
                                        ...
                                        <form className="p-4" onSubmit={handleSubmit}>
                                            ...
                                            <div className="mt-3">
                                                <label className="fs-5" style={{ color: "var(--textColor)" }}>Your Question</label>
                                                <textarea
