...
const Projects = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "We believe in tailoring our services to suit each project's unique requirements, resulting in solutions.",
    },
    {
      id: 3,
      image: Shield,
  ...
  return (
    <>
      <div className="container-fluid">
          ...
          <div className="row">
            <div className="col-12 col-md-8 pt-3 md-pt-5 mt-2 md-mt-5">
              <div className="d-flex flex-column flex-md-row justify-content-start align-items-center ms-0 ms-md-5 gap-4">
                ...
                <img
                  className="img-fluid mb-3 mb-md-1 order-0 order-md-2"
                  src={halfcircle}
                  alt=""
                />
              </div>
              <p
                className="d-flex align-items-center ms-4 w-75 ms-md-5"
                style={{ color: "var( --paraText)", textAlign: "justify" }}
              >
                At NexGen, we are committed to empowering your digital vision
                with innovative solutions tailored to your unique needs. Our
                team of skilled professionals, coupled with cutting-edge
                technologies, ensures that we deliver exceptional results that
        ...
        <div
          className="p-1 mt-3 mt-md-5 rounded"
        ...
        >
          ...
          <div className="container-fluid mt-3">
            <div className="row">
              <div className="row">
                {services
                  .slice(0, showMore || !isMobile ? services.length : 3)
                  .map((service, index) => (
                    <div
                      key={index}
                      className="col-12 ms-2 ms-md-0 col-md-3 mb-2"
                    >
                      <div
                        className="p-4 w-100 h-100 rounded"
                        style={{ backgroundColor: "var(--navbarColor)" }}
                      >
                        <img
              ...
              <div>
                <button
                  className="d-block gap-2 d-md-none d-flex p-2 w-100 justify-content-center align-items-center rounded  backgroundColor"
        ...
        <div
          className="p-2 mt-3 rounded d-md-none"
          style={{ border: "2px solid var(--navbarColor)" }}
        >
          <div
          ...
          <div
            className="d-flex d-md-none overflow-auto mt-3"
        ...
        <div>
          ...
          >
            <div className="row">
              <div className="col-md-4 mb-3 mb-md-1 order-2 order-md-0">
                <div
                  className="rounded p-3 pt-md-5 h-100 w-100"
                  style={{ backgroundColor: "var(--navbarColor)" }}
                >
                  <div className="d-flex gap-5">
                    <div className="d-flex justify-content-start align-items-center gap-2">
                      ...
                      <p
                        className="fs-6"
                        style={{ color: "var(--textColor)", fontSize: "12px" }}
                      >
                        ZENETH FITNESS APP
                      </p>
                    </div>
                  ...
                  <div
                    className="d-flex justify-content-center w-100 mt-3 pt-3 align-items-center"
                    style={{
                      backgroundColor: "var(--btnBackground)",
                      height: "8vh",
                      borderRadius: "2rem",
                  ...
                  >
                    ...
                    >
                      Category{" "}
                      <span
                        className="font-size-12 fs-md-6"
                        style={{ color: "var(--secondaryHoverColor)" }}
                      >
                        {" "}
                        .{" "}
                      </span>{" "}
                  ...
                  <div
                    className="d-flex justify-content-center w-75  mt-3 pt-3 pt align-items-center"
                    style={{
                      backgroundColor: "var(--btnBackground)",
                      height: "8vh",
                      borderRadius: "2rem",
                  ...
                  <div className="mt-3">
                    <p
                      ...
                      style={{ color: "var(--paragraphText)" }}
                    >
                      An all-in-one health and wellness app that offers
                      personalized fitness plans, nutrition guidance, and
                    ...
                    >
                      <div>
                        ...
                        <div className="d-flex flex-wrap mx-3 gap-3">
                          <span
                            className="fs-6 w-25 p-1 d-flex justify-content-center align-items-center"
                            style={{
                              backgroundColor: "var(--btnBackground)",
                              borderRadius: "2rem",
                              color: "var(--color)",
                  ...
                  <div className="col-md-12">
                    ...
                    >
                      <div className="d-flex justify-content-center align-items-center gap-3">
                        <h5 style={{ color: "var(--color)", fontSize: "14px" }}>
                          TEAM MEMBERS
                        </h5>
                        <div className="d-flex gap-1">
                          <div>
                            <img className="w-100" src={Team_1} alt="" />
                          </div>
                          <div>
                            <img className="w-100" src={Team_2} alt="" />
                          </div>
                          <div>
                            <img className="w-100" src={Team_3} alt="" />
                          </div>
                          <div>
                            <img className="w-100" src={Team_4} alt="" />
                          </div>
                          <div>
                            <img className="w-100" src={Team_5} alt="" />
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          >
            <div className="row">
              <div className="col-md-4 mb-md-1 order-3 order-md-0">
                <div
                  className="rounded mt-2 p-3 pt-md-5 h-100 w-100"
                  style={{ backgroundColor: "var(--navbarColor)" }}
                >
                  <div className="d-flex gap-5">
                    <div className="d-flex justify-content-start align-items-center gap-2">
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="fs-6" style={{ color: "var(--color)" }}>
                        Web Design & Development
                      </span>
                    </p>
                  </div>
                  <div
                    className="d-flex justify-content-center w-75 mt-3 pt-3 align-items-center"
                    style={{
                      backgroundColor: "var(--btnBackground)",
                      height: "8vh",
                      borderRadius: "2rem",
                  ...
                  <div className="mt-4">
                    <p
                      ...
                      style={{ color: "var(--paragraphText)" }}
                    >
                      A complete overhaul of a corporate website to enhance its
          ...
          >
            <div className="col-md-4 mb-1 d-md-none">
              <div className="row mb-2">
                <div className="col-md-12">
                  <div
                    className="mt-2 pt-3 rounded"
                    style={{
                      backgroundColor: "var(--navbarColor)",
                      height: "25vh",
                    }}
                  >
                    <p className="mx-3" style={{ color: "var(--color)" }}>
                      TECHANICAL USED
                    </p>
                    <div className="d-flex flex-wrap mx-4 gap-2">
                      <span
                        className="fs-6 p-2 d-flex justify-content-center align-items-center"
                        style={{
                          backgroundColor: "var(--btnBackground)",
                          borderRadius: "2rem",
                          color: "var(--color)",
              ...
              <div className="row mb-2">
                <div className="col-md-12">
                  <div
                    className="d-flex rounded pt-3 justify-content-center align-items-center"
                    style={{
                      backgroundColor: "var(--navbarColor)",
                      height: "20vh",
                    }}
            ...
            <div className="col-md-4 mb-1 d-md-none">
              ...
              <div className="row mb-2">
                <div className="col-md-12">
                  <div
                    className="d-flex pt-3 flex-column rounded justify-content-center align-items-center gap-3"
                    style={{
                      backgroundColor: "var(--navbarColor)",
                      height: "18vh",
                    }}
          ...
          <div>
            <button
              ...
              className="d-block d-md-none d-flex gap-3 p-2 mt-3 justify-content-center align-items-center rounded  w-100 backgroundColor"
              style={{
                color: "var(--paragraphText)",
                outline: "none",
                border: "none",
        ...
        <div
          className="d-flex justify-content-between align-items-center  p-4 mt-4 rounded"
          style={{ backgroundColor: "var(--navbarColor)" }}
        >
                ...
                <div className="col-md-12">
                  ...
                  >
                    ...
                    <form className="p-4" onSubmit={handleSubmit}>
                      ...
                      <button
                        className="rounded w-100 mt-3 p-2 p-md-2 fw-bold fs-5"
                        type="submit"
                        style={{
                          backgroundColor: "var(--secondaryColor)",
                          outline: "none",
