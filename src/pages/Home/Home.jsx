                        ...
                        <div className="col-md-8 firstServiceContainer">
                            <div className="">
                                <div className="heading">
                                    <h1 className="uppercase serviceTextColor d-flex align-items-center gap-4">Partner with
                                ...
                                <div className="headingtwo">
                                    <h1 className="uppercase serviceTextColor">Top-Tier Agencies</h1>
                                </div>
                                <div className="d-flex align-items-center">
                                ...
                                <div className="paragraph">
                                    <p>At TechGuild, we believe in the transformative power of digital solutions. Our team of experts is dedicated to helping businesses like yours thrive in the fast-paced digital landscape.</p>
                                </div>
                            </div>
