    ...
    <div className=" testimonialMaindiv">
      ...
      <div className="container-fluid mycontainer">
        <div className="row gap-2">
          <div className="col-md-2 firstTestimonalbox ">
            <TestimonialCard
              ...
              personDesignation="CEO of Bluetooth"
              personImage={person1}
            />
          </div>
          <div className="col-md-2 firstTestimonalbox ">
            <TestimonialCard
              ...
              personDesignation="Art Director"
              personImage={person2}
            />
          </div>
          <div className="col-md-2 firstTestimonalbox  ">
            <TestimonialCard
              ...
              personName="Lisa Williams"
              personDesignation="CEO Of HealthTech"
              personImage={person3}
            />
          </div>
          <div className="col-md-2  firstTestimonalbox ">
            <TestimonialCard
              ...
              desc="Their responsive design ensures our website looks stunning on all devices, contributing to increased user engagement and customer service."
              personName="Jennifer Lee"
              personDesignation="COO of Foodie Haven"
              personImage={person4}
            />
          </div>
        </div>
